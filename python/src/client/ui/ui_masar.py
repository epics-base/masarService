...
class Ui_masar(object):
    def setupUi(self, masar):
        ...
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.mainwidget)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.mainSplitter = QtGui.QSplitter(self.mainwidget)
        ...
        self.configEventSplitter = QtGui.QSplitter(self.mainSplitter)
