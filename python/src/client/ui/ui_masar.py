...
class Ui_masar(object):
    def setupUi(self, masar):
        ...
        self.configEventSplitter = QtGui.QSplitter(self.mainwidget)
        ...
        self.horizontalLayout_2.addWidget(self.configEventSplitter)
        self.verticalLayout = QtGui.QVBoxLayout()
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.snapshotTabWidget = QtGui.QTabWidget(self.mainwidget)
        ...
        self.restoreMachineButton = QtGui.QPushButton(self.mainwidget)
