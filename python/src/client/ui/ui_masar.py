...
#
# Created: Mon Feb 27 16:48:02 2012
...
class Ui_masar(object):
    def setupUi(self, masar):
        ...
        self.eventGridLayout.addWidget(self.eventFilterLabel, 0, 0, 1, 3)
        ...
        self.eventGridLayout.addWidget(self.timeRangeCheckBox, 1, 0, 1, 3)
        ...
        self.eventGridLayout.addWidget(self.eventStartLabel, 2, 0, 1, 1)
        ...
        self.eventGridLayout.addWidget(self.eventStartDateTime, 2, 2, 1, 2)
        ...
        self.eventGridLayout.addWidget(self.eventEndLabel, 3, 0, 1, 1)
        ...
        self.eventGridLayout.addWidget(self.fetchEventButton, 4, 0, 1, 3)
        ...
        self.snapshotTabWidget = QtGui.QTabWidget(self.widget)
        ...
        self.machinePreviewButton = QtGui.QPushButton(self.widget)
        ...
        self.saveCurrentPreviewButton = QtGui.QPushButton(self.widget)
        ...
        self.getLiveMachineButton = QtGui.QPushButton(self.widget)
        ...
        self.restoreMachineButton = QtGui.QPushButton(self.widget)
