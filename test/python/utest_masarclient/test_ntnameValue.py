...
class TestNTNameValue(unittest.TestCase):
    ...
    def testGetName(self):
        ...
        self.assertEqual(test_ntnv_servicename, "servicename", "servicename returned incorrect default value:  %r" % test_ntnv_servicename)
        self.assertEqual(test_ntnv_configname, "configname", "configname returned incorrect default value:  %r" % test_ntnv_configname)
    ...
    def testGetValue(self):
        ...
        self.assertEqual(test_ntnv_value_one, "masar", "ntnv value one returned incorrect default value:  %r" % test_ntnv_value_one)
        self.assertEqual(test_ntnv_value_two, "sr_test", "ntnv value two returned incorrect default value:  %r" % test_ntnv_value_two)
