...
class TestAlarm(unittest.TestCase):
    ...
    def testStatusChoices(self):
        ...
        for status in status_choices:
            self.assertEqual(type(status), StringType, "non-string status found: " + str(status))
    ...
    def testSeverityChoices(self):
        ...
        for severity in severity_choices:
            self.assertEqual(type(severity), StringType, "non-string severity found: " + str(severity))

    '''
    Tests both default value assignment and getter operation for Status
    '''
    def testGetStatus(self):
        self.assertEqual(self.test_alarm.getStatus(), "NONE", "Default status did not return 'NONE' instead returned: " + str(self.test_alarm.getStatus()))

    '''
    Tests both default value assignment and getter operation for Severity
    '''
    def testGetSeverity(self):
        self.assertEqual(self.test_alarm.getSeverity(), "NONE", "Default severity did not return 'NONE' instead returned: " + str(self.test_alarm.getSeverity()))

    '''
    Tests both default value assignment and getter operation for Message
    '''
    def testGetMessage(self):
        self.assertEqual(self.test_alarm.getMessage(), "", "Default message did not return empty string instead returned: " + str(self.test_alarm.getMessage()))
    ...
    def testSetStatus(self):
        ...
        self.assertEqual(self.test_alarm.getStatus(),  status_choices[status_index], "Status does not match test input:  " + str(self.test_alarm.getStatus()) + " != " + str(status_choices[status_index]))
    ...
    def testSetSeverity(self):
        ...
        self.assertGreaterEqual(severity_index, 0, "No severity choices available to perform test: " + str(severity_index))
        self.test_alarm.setSeverity(severity_choices[severity_index])  # Index may need to be changed if choices change
        self.assertEqual(self.test_alarm.getSeverity(), severity_choices[severity_index], "Severity does not match test input:  " + str(self.test_alarm.getSeverity()) + " != " + str(severity_choices[severity_index]))
    ...
    def testSetMessage(self):
        ...
        self.assertEqual(self.test_alarm.getMessage(), test_message, "Message does not match test input:  " + str(self.test_alarm.getMessage()) + " != " + test_message)
    ...
    def testNonDefaultConstructor(self):
        ...
        self.assertEqual(self.test_alarm.getMessage(), test_message, "test_message did not match assigned value:  " + str(self.test_alarm.getMessage()) + " != " + str(test_message))
        self.assertEqual(self.test_alarm.getStatus(), test_status, "test_status did not match assigned value" + str(self.test_alarm.getStatus()) + " != " + str(test_status))
        self.assertEqual(self.test_alarm.getSeverity(), test_severity, "test_severity did not match assigned value" + str(self.test_alarm.getSeverity()) + " != " + str(test_severity))
